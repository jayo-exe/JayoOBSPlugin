...
namespace JayoOBSPlugin.OBSWebsocketDotNet.Communication
{
    ...
    public class ObsDisconnectionInfo
    {
        ...
        /// </summary>
        public WebSocketSharp.CloseEventArgs WebsocketDisconnectionInfo { get; private set; }
        ...
        public ObsDisconnectionInfo(ObsCloseCodes obsCloseCode, string disconnectReason, CloseEventArgs websocketDisconnectionInfo)
        {
